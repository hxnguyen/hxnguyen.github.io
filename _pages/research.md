...
<!-- Current projects
     ===============
     Fill in one bullet per ACTIVE project only, then delete these comment markers.
     Template:
     * **<Project title>.** Funded by <funding organisation>. Role: <your role>.
       With <collaborators>. <start year>–<end year>. <One-sentence objective.>
       [Project page](<public link, if any>)
     Do not list funding applications here until their status permits public disclosure. -->
...
<!-- The hexagon diagram below lists seven older themes (tactical comms, MLSecOps, UAV)
     ...
     Re-enable once the figure is regenerated:
![Research themes](https://hxnguyen.github.io/files/Research_Projects.png "Research themes") -->
